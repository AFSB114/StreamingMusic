...
public class albumDTO {
    ...
    public albumDTO(int album_id, int artist_id, int record_label_id, String title, Date release_date, String cover_url, String type, int total_duration, String description) {
